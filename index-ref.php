...
<body>
<p><a href="/" id="logo" rel="home" title="Home"><img alt="LifeWOW" src="http://life.worldsowisdom.com/sites/default/files/LifeWOW.png" />LifeFLOW<img alt="Hearts" src="img/hearts.svg" width="60"></a></p>
...
//		xhr.open("GET","save.php?tub=testnewtub4&creaturez=SVG headers...: " + creaturezready); //"creatures/1234567.svg"); //what goes in 2nd/3rd params? "index.php"? "creatures/1234567"? ...?
	...
	*/
	...
	function clone(creature) {
		...
		clone_array[clone_index].setAttribute("transform","translate(-40,20)"); // translate the new clone.
...
<a style="fill-opacity:0.75" xlink:href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=V5C7SW55G7J2S"> 
	...
	<!--Button4: Download creature-->
	
	<g id="Download"
				onmouseout="setAttribute('fill-opacity','0.75')" onmouseover="setAttribute('fill-opacity','0.9')" onmousedown="download()";>
				<title>Download creature! :)</title>
	
			<rect height="32" width="32" x="150" y="40" id="Button4"  style="fill:yellow;stroke:lightgreen;opacity:0.75" onmousedown="Turn()" onmouseout="setAttribute('fill-opacity','0.75')" onmouseover="setAttribute('fill-opacity','1.0')"> <desc id="First button on toolbar! :)">A clickable square to test simple JavaScript.</desc>
			</rect>
	...
	<!--Button 5: Upload creature-->
	
	<g id="Upload"
				onmouseout="setAttribute('fill-opacity','0.75')" onmouseover="setAttribute('fill-opacity','0.9')" onmousedown="upload()";>
